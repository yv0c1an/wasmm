...
insert into sys_dict_type values(3,  '系统开关', 'sys_normal_disabled',  '0', 'admin', sysdate(), '', null, '系统开关列表');
...
insert into sys_dict_data values(6,  1,  '正常',     '0',       'sys_normal_disabled',  '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '正常状态');
insert into sys_dict_data values(7,  2,  '停用',     '1',       'sys_normal_disabled',  '',   'danger',  'N', '0', 'admin', sysdate(), '', null, '停用状态');
