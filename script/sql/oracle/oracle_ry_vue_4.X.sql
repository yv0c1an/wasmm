...
insert into sys_menu values('4', 'PLUS官网', '0', '4', 'https://gitee.com/bkywksj/ruoyi-vue-plus-uniapp', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate, '', null, 'RuoYi-Vue-Plus官网地址');
-- 二级菜单
...
comment on column sys_logininfor.username      is '登录账号';
