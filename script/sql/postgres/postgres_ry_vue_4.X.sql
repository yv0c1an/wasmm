...
insert into sys_menu values('4', 'PLUS官网', '0', '4', 'https://gitee.com/bkywksj/ruoyi-vue-plus-uniapp', null, '', '0', '0', 'M', '0', '0', '', 'guide',    'admin', now(), '', null, 'RuoYi-Vue-Plus官网地址');
-- 二级菜单
...
(
    info_id        int8,
    username      varchar(50)  default ''::varchar,
...
comment on column sys_logininfor.username is '用户账号';
