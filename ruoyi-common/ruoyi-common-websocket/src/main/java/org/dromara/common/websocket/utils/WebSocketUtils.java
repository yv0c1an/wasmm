...
public class WebSocketUtils {
     ...
     * @param message    消息文本
     */
    public static String sendMessage(Long sessionKey, String message) {
    ...
    public static String sendMessage(WebSocketSession session, String message) {
        return sendMessage(session, new TextMessage(message));
    }

    private static String sendMessage(WebSocketSession session, WebSocketMessage<?> message) {
