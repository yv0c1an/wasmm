package org.dromara.system.post.controller;
...
public class SysPostController extends BaseController {
    ...
    @PostMapping("/export")
    public void export(SysPostBo post, PageQuery pageQuery, HttpServletResponse response) {
        TableDataInfo<SysPostVo> info = postService.selectPagePostList(post, pageQuery);
        ExcelUtil.exportExcel(info.getRows(), "岗位数据", SysPostVo.class, response);
    }
