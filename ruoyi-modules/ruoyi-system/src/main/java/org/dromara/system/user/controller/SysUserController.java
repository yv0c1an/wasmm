...
import org.dromara.system.dept.domain.bo.SysDeptBo;
import org.dromara.system.dept.domain.vo.SysDeptVo;
import org.dromara.system.post.domain.bo.SysPostBo;
import org.dromara.system.role.domain.bo.SysRoleBo;
import org.dromara.system.role.domain.vo.SysRoleVo;
import org.dromara.system.user.domain.bo.SysUserBo;
import org.dromara.system.user.domain.vo.*;
import org.dromara.system.user.listener.SysUserImportListener;
import org.dromara.system.dept.service.ISysDeptService;
import org.dromara.system.post.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    @PostMapping("/export")
    public void export(SysUserBo user, PageQuery pageQuery, HttpServletResponse response) {
        TableDataInfo<SysUserVo> info = userService.selectPageUserList(user, pageQuery);
        List<SysUserVo> list = info.getRows();
    ...
    public R<SysUserInfoVo> getInfo(@PathVariable(value = "userId", required = false) Long userId) {
        ...
        userInfoVo.setPosts(postService.selectPostList(post));
