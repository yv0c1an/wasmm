package org.dromara.system.social.service.impl;

import cn.hutool.core.bean.BeanUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import org.dromara.system.social.domain.SysSocial;
import org.dromara.common.mybatis.core.domain.BaseEntity;
import org.dromara.system.social.domain.bo.SysSocialBo;
import org.dromara.system.social.domain.vo.SysSocialVo;
import org.dromara.system.social.mapper.SysSocialMapper;
...
public class SysSocialServiceImpl implements ISysSocialService {
    ...
    public Boolean insertByBo(SysSocialBo bo) {
        SysSocial add = BeanUtil.toBean(bo, SysSocial.class);
    ...
    public Boolean updateByBo(SysSocialBo bo) {
        SysSocial update = BeanUtil.toBean(bo, SysSocial.class);
