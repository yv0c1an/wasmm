package org.dromara.system.user.service;
...
public interface ISysUserService {
     ...
     * 统计最后登录时间区间用户 即活跃用户
     */
    Long countBetweenLoginDate(DateTime begin, DateTime end);

    /**
     * 创建用户
     */
    SysUserVo createUser(Long userId, String openid, String nickname, String avatar);
     ...
     * @return
     */
    List<SysUserVo> listUserByDeptId(Long deptId);
     ...
     * 统计创建时间区间内新增用户数量
     */
    Long countBetweenCreateTime(DateTime begin, DateTime end);

    List<ChartVo> statHourNewUser();
}
