package org.dromara.system.role.controller;
...
import org.dromara.system.role.domain.vo.DeptTreeSelectVo;
...
public class SysRoleController extends BaseController {
    ...
    @PostMapping("/export")
    public void export(SysRoleBo role, PageQuery pageQuery, HttpServletResponse response) {
        TableDataInfo<SysRoleVo> info = roleService.selectPageRoleList(role, pageQuery);
        ExcelUtil.exportExcel(info.getRows(), "角色数据", SysRoleVo.class, response);
    }
