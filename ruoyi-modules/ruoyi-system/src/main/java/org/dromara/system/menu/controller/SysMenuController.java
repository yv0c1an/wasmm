package org.dromara.system.menu.controller;
...
import org.dromara.system.menu.domain.vo.MenuTreeSelectVo;
...
public class SysMenuController extends BaseController {
    ...
    public R<List<SysMenuVo>> list(SysMenuBo menu) {
        List<SysMenuVo> menus = menuService.selectMenuList(menu, getUserId());
        return R.ok(menus);
    }
