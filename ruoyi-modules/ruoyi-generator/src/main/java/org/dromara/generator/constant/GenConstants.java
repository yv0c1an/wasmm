...
public interface GenConstants {
     ...
     * VO对象 不需要返回字段
     */
    String[] COLUMNNAME_NOT_LIST = {"create_dept", "create_by", "del_flag", "update_by", "version"};
     ...
     * Tree基类字段
     */
    String[] TREE_ENTITY = {"createDept", "parentName", "parentId", "orderNum", "ancestors", "children"};
