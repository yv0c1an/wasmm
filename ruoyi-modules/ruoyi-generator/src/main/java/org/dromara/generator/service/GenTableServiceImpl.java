...
public class GenTableServiceImpl implements IGenTableService {
    ...
    public void validateEdit(GenTable genTable) {
        if (GenConstants.TPL_TREE.equals(genTable.getTplCategory())) {
            ...
            }else if(ObjectUtil.isNull(baseMapper.selectGenTableByName(genTable.getSubTableName()))){
                throw new ServiceException(StringUtils.format("请先导入子表:{}进行配置", genTable.getSubTableName()));
            }
        }
    }
